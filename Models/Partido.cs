...
namespace TorneoPOO_CRAMIREZ.Models
{
    public class Partido
    {
        ...
        {
            Console.WriteLine($"Hay un partido programado entre el local {Local.Nombre} y el visitante {Visitante.Nombre} en el lugar {Lugar} para la fecha {Fecha.ToShortDateString()}.");
        }
    }
}